...
$(function() {
  $('.comments').on('click', '.comment_entries .comment_entry .comment_footer .delete_comment', function() {
...
// Removed the '#' from '#sourceMappingURL=underscore-min.map' to disable this feature for now
;
(function() {
  this.Gmaps = {
